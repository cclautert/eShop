...
- Install the latest [.NET 8 SDK](https://github.com/cclautert/installer#installers-and-binaries)
...
The sample catalog data is defined in [catalog.json](https://github.com/cclautert/eShop/blob/main/src/Catalog.API/Setup/catalog.json). Those product names, descriptions, and brand names are fictional and were generated using [GPT-35-Turbo](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/chatgpt), and the corresponding [product images](https://github.com/cclautert/eShop/tree/main/src/Catalog.API/Pics) were generated using [DALL·E 3](https://openai.com/dall-e-3).
